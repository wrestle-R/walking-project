      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="mb-16">
          <p className="text-gray-300 leading-relaxed text-lg">
            Our comprehensive survey of the Bandra to Santacruz stretch reveals significant 
            challenges in pedestrian accessibility. The 3.5km route contains 12 major 
            obstacles, including broken pavements, unauthorized parking, and street vendor 
            encroachments. Based on 156 survey responses, we've identified key areas 
        ...
        <div className="mb-16">
          <p className="text-gray-300 leading-relaxed text-lg">
            Key findings indicate peak pedestrian traffic during morning (9 AM) and 
            evening (6 PM) hours, with an average of 420 pedestrians during peak times. 
            Infrastructure assessment shows 45% of the stretch in good condition, while 
            25% requires urgent maintenance. The most common accessibility challenges 
            include inadequate ramps and inconsistent tactile pathway implementation.
          </p>
        </div>
